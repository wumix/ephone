...
$checkTrackQuery                =   $db->prepare("SELECT * FROM albums WHERE id = :id AND uid = :uid");
...
$updateTrackQuery               =   $db->prepare("UPDATE albums SET album_header_image = :img
...
$response['status']             =   2;
$response['message']            =   "Album header image successfully uploaded!";
